...
selectAddEventListener("clinic-timing-mon", "mon-time");
selectAddEventListener("clinic-timing-tue", "tue-time");
selectAddEventListener("clinic-timing-wed", "wed-time");
selectAddEventListener("clinic-timing-thu", "thu-time");
selectAddEventListener("clinic-timing-fri", "fri-time");
selectAddEventListener("clinic-timing-sat", "sat-time");
selectAddEventListener("clinic-timing-sun", "sun-time");
...
function handleOnClinicTimingForm(csrfToken, clinicId){
    ...
    function dayValidation(day) {
        const dayCheck =  document.forms['clinicTimingForm'][`clinic-timing-${day}`];
